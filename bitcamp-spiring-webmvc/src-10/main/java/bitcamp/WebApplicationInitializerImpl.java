...
public class WebApplicationInitializerImpl
  ...
  @Override
  protected Class<?>[] getServletConfigClasses() {// 3rd
  ...
  @Override
  protected String[] getServletMappings() {// 4th
  ...
  @Override
  protected String getServletName() { // 2nd
  ...
  @Override
  public void onStartup(ServletContext servletContext) throws ServletException {// 1st
