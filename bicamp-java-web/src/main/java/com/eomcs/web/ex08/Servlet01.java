...
// HTTP 응답 프로토콜 예:
/*
 * HTTP/1.1 200 Refresh: 3;url=s100 Content-Type: text/plain;charset=UTF-8 Content-Length: 29 Date:
 * Tue, 07 Apr 2020 06:47:14 GMT Keep-Alive: timeout=20 Connection: keep-alive
 *
 * 안녕하세요! - /ex08/s1
 */
