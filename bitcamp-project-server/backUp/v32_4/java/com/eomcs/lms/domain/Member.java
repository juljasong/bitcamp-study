...
public class Member implements Serializable {
  ...
  private static final long serialVersionUID = 765542141820646770L;
  private int no;
  private String name, email, password, photo, tel;
  ...
  public String toCsvString() {
    return String.format("%d, %s, %s, %s, %s, %s, %s", this.getNo(), this.getName(),
        this.getEmail(), this.getPassword(), this.getPhoto(), this.getTel(),
