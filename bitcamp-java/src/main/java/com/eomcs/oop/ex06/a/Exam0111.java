...
public class Exam0111 {
    ...
    public static void main(String[] args) {
        ...
        // 하위 클래스의 인스턴스는 상위 클래스의 인스턴스 멤버를 갖고 있기 때문에 상위 레퍼런스로 하위 클래스의 인스턴스를 가리킬 수 있음
        // => 상위 클래스의 레퍼런스로 상위 클래스 인스턴스 멤버 사용 가능
        // Vehicle 변수 v2가 Bike 객체를 가리킨다면
        v2 = b;
        // v2를 통해 Vehicle의 인스턴스 변수에 접근 가능
        
        v2.model = "티코";
        v2.capacity = 5;
        // Bike 인스턴스에는 수퍼클래스 Vehicle의 인스턴스 변수가 있기 때문
    }
