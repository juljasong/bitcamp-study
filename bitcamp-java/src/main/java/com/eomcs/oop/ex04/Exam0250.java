...
public class Exam0250 {
    public static void main(String[] args) throws Exception {
        ...
        // 인스턴스 메서드 활용
        System.out.println(c.get(1)); // 년도 : 2019
        System.out.println(c.get(2) + 1); // 월(0 ~ 11) : 12
        System.out.println(c.get(5)); // 일 : 30
        System.out.println(c.get(7)); // 요일(1 ~ 7) :2
        System.out.println(c.get(4)); // 그 달의 몇 번째 주 : 5
        System.out.println(c.get(10)); // 시(0 ~ 11) : 4
        System.out.println(c.get(11)); // 시(24시) : 16
        System.out.println(c.get(12)); // 분 : 3
        System.out.println(c.get(13)); // 초 : 29
       System.out.println("===========");
