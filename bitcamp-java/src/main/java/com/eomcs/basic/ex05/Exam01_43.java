...
public class Exam01_43 {
  public static void main(String[] args) {
    ...
    float r1 = f1 + f2; 
    System.out.println(r1); // 988.765411 -> 988.7654
    // 출력 이유?
    ...
    double r2 = f1 + f2;
    System.out.println(r2); // 788.765411 -> 988.765380859375
    // 출력이유?
    // float 값(988.7654...)을 
    // double 변수에 저장할 때 정확하게 저장되지 않는다.
    // IEEE 754의 이진수 변환 문제때문이다. 4바이트 float 부동소수점을 8바이트 double 부동소수점 변수에 저장할 때 왜곡된 값이 들어갈 수 있음
    // -> 다음과 같이 처음부터 double 변수 사용하자
    ...
    // 그럼에도 불구하고 붙은 맨 뒤의 작은 수는 그냥 잘라 버리면 된다.
  }
}
